sap.ui.define([
    ...
    function (Controller, Filter, Common, JSONModel, History, MessageBox) {
        ...
        return Controller.extend("zuiio2.controller.IOCreateColor", {    
            onInit: function(){
                that = this;  
                ...
                this._router.getRoute("RouteIOCreateColor").attachPatternMatched(this._routePatternMatched, this);
            ...
            _routePatternMatched: function (oEvent) {
                ...
                oModel.read("/AddIOColorSet", {
                    urlParameters: {
                        "$filter": "IONO eq '" + this._ioNo + "'"
                    },
                    success: function(oData, oResponse) {
                        oJSONModel.setData(oData.results);
                        oView.setModel(oJSONModel, "IOCREATECOLOR_MODEL");
                ...
                var oData = this.getOwnerComponent().getModel("IOCREATECOLOR_MODEL").getData().data;
                oData.forEach(item => item.EDITED = false);
                console.log(oData)
                this.getView().setModel(new JSONModel(oData), "iocreatecolor");
