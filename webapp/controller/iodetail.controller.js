sap.ui.define([
    ...
    function (Controller, Filter, Common, Utils, Constants, JSONModel, jQuery, HashChanger, MessageStrip, control, FASummary, MessageBox, History) {
        ...
        return Controller.extend("zuiio2.controller.iodetail", {
                    ...
                    if (this._ioNo === "NEW") {
                        ...
                        setTimeout(() => {
                            ...
                            oModel.create("/IOHDRSet", oParamIOHeaderData, {
                                ...
                                success: function (oData, oResponse) {
                                    me._ioNo = oData.IONO;
                                    // alert(newIONO);
                                    Common.showMessage("IO# " + me._ioNo + " generated.");
                                },
                                error: function (err) {
                        ...
                        setTimeout(() => {
                            ...
                            oModel.update("/IOHDRSet(IONO='" + me._ioNo + "')", oParamIOHeaderData, {
                                ...
                                success: function (oData, oResponse) {
                                    // alert(newIONO);
                                    Common.showMessage("IO# " + me._ioNo + " updated.");
                                },
                                error: function (err) {
            ...
            onSave(arg) {
                var me = this;
                var aNewRows = this.byId(arg + "Tab").getModel().getData().rows.filter(item => item.New === true && item.EDITED === true);
                var iNew = 0;
                var aEditedRows = this.byId(arg + "Tab").getModel().getData().rows.filter(item => item.New !== true && item.EDITED === true);
                var iEdited = 0;
